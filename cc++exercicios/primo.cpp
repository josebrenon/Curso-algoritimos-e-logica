...
int main()
{
    int n, tot = 0, i = 2;   printf("Digite um numero para saber se ele eh primo: ");
    scanf("%d", &n);
    ...
    if (tot > 0)
        printf("O numero %d eh divisivel por 1 e por mais %d numeros\nPor isso ele NAO EH PRIMO!",n, tot);
    else
        printf("O numero %d so eh divisivel por 1 e por ele mesmo\nPor isso ele EH PRIMO!",n);  
